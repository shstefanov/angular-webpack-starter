...
module.exports = function (options) {
  ...
  return {
    ...
    output: {
       ...
       */
      // Pointing to laravel backend public folder
      path: path.join(process.cwd(), cfg.output_path),
      
      
      // Prefix for assets path
    ...
    plugins: [
      ...
      // This is fix for "__extends is not defined" error
